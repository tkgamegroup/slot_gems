...
func curve_to(tween : Tween, target, p3 : Vector2, ctrl1_t : float, ctrl1_o : Vector2, ctrl2_t : float, ctrl2_o : Vector2, duration : float):
	var d = {}
	d.p3 = p3
	...
	tween.parallel().tween_method(func(t):
		target.global_position = Math.cubic_bezier(d.p0, d.p1, d.p2, d.p3, t)
	, 0.0, 1.0, duration)
