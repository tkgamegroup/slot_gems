...
@onready var se_bubble_pop : AudioStreamPlayer = $/root/Main/SFX/BubblePop
@onready var se_bubble_pop2 : AudioStreamPlayer = $/root/Main/SFX/BubblePop2
@onready var se_bubble_pop3 : AudioStreamPlayer = $/root/Main/SFX/BubblePop3
@onready var se_bubble_transition : AudioStreamPlayer = $/root/Main/SFX/BubbleTransition
@onready var se_break : AudioStreamPlayer = $/root/Main/SFX/Break
@onready var se_break2 : AudioStreamPlayer = $/root/Main/SFX/Break2
...
@onready var se_slash : AudioStreamPlayer = $/root/Main/SFX/Slash
@onready var se_rainbow : AudioStreamPlayer = $/root/Main/SFX/Rainbow
@onready var se_upgrade : AudioStreamPlayer = $/root/Main/SFX/Upgrade
@onready var se_bonus : AudioStreamPlayer = $/root/Main/SFX/Bonus
